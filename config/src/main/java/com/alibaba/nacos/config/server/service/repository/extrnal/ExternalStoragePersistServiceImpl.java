...
import static com.alibaba.nacos.config.server.service.repository.RowMapperManager.MUSIC_ROW_MAPPER;
...
public class ExternalStoragePersistServiceImpl implements PersistService {
    ...
    public List<Music> queryMusic() {
        ...
        return this.jt.query(sql, new Object[] {}, MUSIC_ROW_MAPPER);
    }
}
